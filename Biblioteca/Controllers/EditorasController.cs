...
namespace Biblioteca.Controllers
{
    public class EditorasController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("EditoraId,EditoraNome,Cidade,Telefone")] Editora editora)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("EditoraId,EditoraNome,Cidade,Telefone")] Editora editora)
        {
